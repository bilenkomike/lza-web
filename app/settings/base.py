...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "app.context_processors.navigation_pages",
            ],
        },
    },
]
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # usually for deployment
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("EMAIL_FROM", "mbdevcons@gmail.com")
